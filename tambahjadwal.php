...
<body>
	...
	<div class="tabelnya">
		<h2 align="center">Tambah Jadwal Sidang MKS</h2><br>
		...
		<form name="ubahjadwal" id="ubahjadwal" action="simpanjadwal.php" method="post">
			<table align="center">
					...
					<td> Mahasiswa </td>
			 		<td>
			 			<select name="selectmhs" id="mhs">
							<?php
								//$db = pg_connect("dbname=postgres user=postgres port=5432 password=basdat13");
				...
				<tr>
					<td> Tanggal </td>
					<td>
				 		<input type="date" class="form-control" id="date" name="tanggal" placeholder="YYYY-MM-DD">
					</td>
			 	</tr>
				...
				<tr>
					<td> Jam Mulai </td>
			 		<td>
				 		<input type="time" class="form-control" id="time1" name="jammulai" placeholder="HH:MM">
					</td>
		 		</tr>
				...
				<tr>
					<td> Jam Selesai </td>
					<td>
						<input type="time" class="form-control" id="time2" name="jamselesai" placeholder="HH:MM">
					</td>
		 		</tr>
			...
			<input type="submit" class="btn btn-success" align="center"  name="batal" value="BATAL">
 	</div>
